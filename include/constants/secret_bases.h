...
/*COMMENT UPDATE, MUST READ
The comment above is legacy. In order to allow a larger number of unique bases to exist,
the calculation that determines the secret base id had its divider reduced from 10 to 4.
This means each secret base map can be used by 4 different secret base locations in
the game.*/
